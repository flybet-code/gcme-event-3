...
const authClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$react$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAuthClient"])({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:3003") || (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : undefined),
    plugins: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$custom$2d$session$2f$client$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["customSessionClient"])()
    ]
});
}),
...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const { error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                email,
                password
            });
            if (signInError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6c70221._.js.map